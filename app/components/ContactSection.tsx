...
const ContactSection = () => {
  return (
    <section
      id="kontak"
      className="w-11/12 mx-auto flex flex-col items-center py-30"
    >
      <div className="w-full md:w-xl mb-10 md:mb-20 self-start">
        ...
        <AnimatedItem direction="horizontal" reverse={true} delay={0.3}>
          <p className="leading-relaxed mt-8 text-slate-600">
            Punya ide proyek yang menarik, tawaran kerja sama, atau sekadar
            ingin menyapa? Jangan ragu untuk mengirim pesan. Aku selalu terbuka
            untuk obrolan seru dan peluang baru!
          </p>
        </AnimatedItem>
      </div>
      <AnimatedItem
      ...
      >
        ...
        <div className="w-full md:w-1/2 px-6 py-10 md:py-0 md:px-15 flex flex-col justify-center gap-6 md:gap-10 bg-white md:bg-transparent">
      ...
      <AnimatedItem
        direction="vertical"
        className="w-full h-96 md:h-150 mt-10 md:mt-20 rounded-xl overflow-hidden shadow-xl"
      >
        <iframe
